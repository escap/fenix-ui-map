...
require([
	...
	var layerOP = new L.OverPassLayer({
	...
	m.map.addLayer(layerOP);

	m.map.fitBounds(L.latLngBounds([[22.181396,25.254632],[35.683593,32.907262]]));
