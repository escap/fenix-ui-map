...
require([
	...
	for (var i=0; i < r.joindata.length; i++) {
	 ...
	 $.ajax({
	     type: 'POST',
	     url: 'http://localhost:5000/mapclassify/join',
	     ...
	     success : function(response) {
	         ...
	         $.ajax({
	             type: 'GET',
	             url: 'http://fenix.fao.org/test/geo/fenix/spatialquery/db/spatial/centroid/layer/gaul0_faostat_3857/faost_code/' + codes.toString() +'/labels/faost_code,areaname',
	             success : function(response) {
